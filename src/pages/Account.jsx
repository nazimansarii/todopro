...
export const Account = () => {
  ...
  return (
    <div
      className={`w-full h-fit sm:px-4 sm:max-h-screen sm:overflow-auto custom-scrollbar ${
    ...
    >
      ...
      <div className="px-2 sm:px-5    rounded-2xl shadow-lg sm:p-6 mb-8  ">
        ...
        <div className="mt-8 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-800 p-4 rounded">
